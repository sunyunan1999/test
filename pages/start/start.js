...
Page({
  ...
  send: function () {
    ...
    const requestTask = wx.request({
      ...
      success: function (res) {
        ...
        var str = res.data.results[1].weather_data[1].date;
  ...
  getDataFromOneNet: function () {
    ...
    const requestTask = wx.request({
      ...
      url: 'http://api.heclouds.com/devices/503120805/datapoints?datastream_id=Temperature,Humidity&limit=1',

      header: {

        'content-type': 'application/json',

        'api-key': '=4PjE6e0KlQS5uo6l6Wt7yJOOfY= '
